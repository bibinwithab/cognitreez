            ...
            >
              <div className="grid md:grid-cols-2">
                <div className="p-8 bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                  ...
                  {[
                    { icon: <Clock className="w-5 h-5" />, text: "30-minute strategy session" },
                    { icon: <Calendar className="w-5 h-5" />, text: "Personalized action plan" },
                    { icon: <Phone className="w-5 h-5" />, text: "Direct access to experts" }
                  ].map((item, index) => (
                    <motion.div
                      key={index}
